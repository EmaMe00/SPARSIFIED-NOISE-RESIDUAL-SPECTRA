...
## Dataset
For our experiments we used the generative images dataset available at [link](https://zenodo.org/records/10066460), published by Université Paris-Saclay et al. The dataset of real images was built using some real images available at [link](https://www.kaggle.com/datasets/prasunroy/natural-images). The training, validation and test sets were divided with an 80-10-10 proportion.
...
We provide a set of pre-processing scripts to generate the sparsified spectra. The generation of the plain noise residuals spectra requires the NN available at [link](https://github.com/grip-unina/SyntheticImagesAnalysis/).
